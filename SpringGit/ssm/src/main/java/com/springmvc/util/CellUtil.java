...
public class CellUtil {
   ...
   public static void setCellValue(Cell cell, Object object){
    ...
    public static void setCellValue(Cell cell, Object object, String model){
        if(object == null){
            cell.setCellValue("");  
        }else{
            if (object instanceof String) {
    ...
    public static void setCellValue(Cell cell, String object){
        if(object == null){
            cell.setCellValue("");  
        }else{
   ...
   public static void setCellValue(Cell cell, Long object){
        if(object == null){
            cell.setCellValue("");  
        }else{
    ...
    public static void setCellValue(Cell cell, Double object){
        if(object == null){
            cell.setCellValue("");  
        }else{
            cell.setCellValue(object.doubleValue());  
    ...
    public static void setCellValue(Cell cell, Date object, String model){
        if(object == null){
            cell.setCellValue("");  
        }else{
            cell.setCellValue(new SimpleDateFormat(model).format(object));  
    ...
    public static void setCellValue(Cell cell, java.util.Date object, String model){
        if(object == null){
            cell.setCellValue("");  
        }else{
            cell.setCellValue(new SimpleDateFormat(model).format(object));  
    ...
    public static void setCellValue(Cell cell, BigDecimal object){
        if(object == null){
            cell.setCellValue("");  
       }else{
